      ...
      <div className='row gap-5 justify-content-center align-items-center'>
        ...
        <div className='col-8 row gap-3 justify-content-center'>
          <div className='biography col-12'>
            ...
            <div>
              Soy programador Junior Full Stack. Aún me encuentro cursando la
              carrera de Licenciatura en Informática, también soy Docente
              Auxiliar Universitario en la UNQui. Actualmente me encuentro en
              búsqueda de un trabajo como desarrollador. Pueden descargar mi
              Curriculum justo aquí debajo. Mis redes se encuentran al pie de la
              página!
            </div>
          </div>
